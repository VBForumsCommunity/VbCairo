...
Private Sub Form_Load()
    ...
    cairo_set_font_size pCr, 52#
    cairo_text_extents pCr, sUtf8, tExtents
    
    dX = 128# - (tExtents.Width / 2 + tExtents.x_bearing)
    dY = 128# - (tExtents.Height / 2 + tExtents.y_bearing)
    ...
    cairo_fill pCr
    cairo_move_to pCr, 128#, 0
    cairo_rel_line_to pCr, 0, 256
    cairo_move_to pCr, 0, 128#
    cairo_rel_line_to pCr, 256, 0
    cairo_stroke pCr
