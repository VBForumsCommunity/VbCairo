...
Private m_cRegExpCache              As New Collection
...
Public Function At(vArray As Variant, ByVal lIdx As Long) As String
    On Error GoTo QH
...
Public Function InitRegExp(sPattern As String) As Object
    ...
    If SearchCollection(m_cRegExpCache, sPattern) Then
        Set InitRegExp = m_cRegExpCache.Item(sPattern)
    Else
