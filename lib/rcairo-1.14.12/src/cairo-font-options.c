 ...
 * Since: 1.0
 **/
cairo_font_options_t * CAIRO_CALLCONV
 ...
 **/
cairo_status_t
CAIRO_CALLCONV cairo_font_options_status (cairo_font_options_t *options)
{
    if (options == NULL)
 ...
 **/
unsigned long
CAIRO_CALLCONV cairo_font_options_hash (const cairo_font_options_t *options)
{
    if (cairo_font_options_status ((cairo_font_options_t *) options))
 ...
 **/
cairo_antialias_t
CAIRO_CALLCONV cairo_font_options_get_antialias (const cairo_font_options_t *options)
{
    if (cairo_font_options_status ((cairo_font_options_t *) options))
...
CAIRO_CALLCONV cairo_font_options_get_subpixel_order (const cairo_font_options_t *options)
{
    if (cairo_font_options_status ((cairo_font_options_t *) options))
 ...
 **/
cairo_hint_style_t
CAIRO_CALLCONV cairo_font_options_get_hint_style (const cairo_font_options_t *options)
{
    if (cairo_font_options_status ((cairo_font_options_t *) options))
...
CAIRO_CALLCONV cairo_font_options_get_hint_metrics (const cairo_font_options_t *options)
{
    if (cairo_font_options_status ((cairo_font_options_t *) options))
