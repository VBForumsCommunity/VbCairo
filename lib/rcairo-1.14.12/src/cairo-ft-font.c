 ...
 **/
unsigned int
CAIRO_CALLCONV cairo_ft_font_face_get_synthesize (cairo_font_face_t *font_face)
{
    cairo_ft_font_face_t *ft;
 ...
 **/
FT_Face
CAIRO_CALLCONV cairo_ft_scaled_font_lock_face (cairo_scaled_font_t *abstract_font)
{
 ...
 **/
void
CAIRO_CALLCONV cairo_ft_scaled_font_unlock_face (cairo_scaled_font_t *abstract_font)
{
    cairo_ft_scaled_font_t *scaled_font = (cairo_ft_scaled_font_t *) abstract_font;
