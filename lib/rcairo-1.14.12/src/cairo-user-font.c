 ...
 * Since: 1.8
 **/
cairo_user_scaled_font_init_func_t CAIRO_CALLCONV
 ...
 * Since: 1.8
 **/
cairo_user_scaled_font_render_glyph_func_t CAIRO_CALLCONV
 ...
 * Since: 1.8
 **/
cairo_user_scaled_font_text_to_glyphs_func_t CAIRO_CALLCONV
 ...
 * Since: 1.8
 **/
cairo_user_scaled_font_unicode_to_glyph_func_t CAIRO_CALLCONV
